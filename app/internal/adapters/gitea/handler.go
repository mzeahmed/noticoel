...
// Handler handles Gitea webhook requests.
type Handler struct {
...
// Receive handles POST /api/v1/adapters/gitea. It decodes Gitea's
...
func (h *Handler) Receive(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		h.log.Error("failed to store event", "adapter", "gitea", "error", err)
